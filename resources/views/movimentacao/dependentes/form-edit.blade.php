...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Editar dependente: ' . $dependente->name])
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                            ...
                            <form action="{{ route('dependentes.update', ['id' => base64_encode($dependente->id)]) }}"
                                method="post">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="text" value="{{ $dependente->cpf }}" required name="cpf"
                                        ...
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="text" value="{{ $dependente->name }}" required
                                        ...
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="date" value="{{ $dependente->data_nascimento }}" required
                                        ...
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="text" value="{{ $dependente->rg }}" required name="rg"
                                                    onkeypress="return apenasNumeros();" class="form-control"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm">
                                                <div class="flex flex-col">
                                                    ...
                                                    <select name="tipo_dependente" id="tipo_dependente"
                                                        class="form-control">
                                                        <option selected>@lang('labels.option-padrao')</option>
                                            ...
                                            <div class="col-sm">
                                                <div class="flex flex-col">
                                                    ...
                                                    <input type="text" value="{{ $dependente->celular }}" required
                                                        name="celular" onkeypress="mask(this, mphone);"
                                            ...
                                            {{-- <div class="col-sm">
                                                <div class="flex flex-col">
                                                    <label for="edit">@lang('labels.edit')</label>
