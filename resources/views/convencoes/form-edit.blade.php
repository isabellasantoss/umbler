                        ...
                        <div class="card shadow">
                            <div class="card-header border-0">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">@lang('labels.convencoes_editar')</b></h3>
                                    </div>
                            ...
                            <form action="{{ route('convencoes.update',  ['id' => base64_encode($convencoes->id)]) }}" method="post">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                placeholder="@lang('labels.CCT')" id="cct" value="{{ $convencoes->cct }}"
                                        ...
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="text" name="sind_patronal" class="form-control form-control-lg"
                                                    placeholder="@lang('labels.sind_patronal')" id="sind_patronal" value="{{ $convencoes->sind_patronal }}"
                                        ...
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="text" name="sind_laboral" class="form-control form-control-lg"
                                                    placeholder="@lang('labels.sind_laboral')" id="sind_laboral" value="{{ $convencoes->sind_laboral }}"
                                        ...
                                        <div class="col-sm">
                                            <div class="flex flex-col">
                                                <label for="abrangencia">@lang('labels.abrangencia')</label>
                                                    <select name="abrang" id="estado_emissor_rg"
                                                    class="form-control">
